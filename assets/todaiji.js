(() => {
  ...
  if (objectRoom) {
    ...
    if (objectGrid) objectGrid.innerHTML = `
      ...
      <article data-object-material="bronze"><span>鍍金銅 · 8世紀 · 國寶</span><h3>誕生釋迦佛與灌佛盤</h3><p><strong>先理解：</strong>小像右手指天、左手指地，原為佛誕日灌佛會使用。香水由小像頭頂澆下，再落入大型盤中；像與盤的比例由儀式操作決定。</p><p><strong>現場看：</strong>小像的手勢、腰部轉折、金層磨損；盤上浮雕或線刻如何把龍、花與佛誕敘事繞成一圈。把它當作被反覆使用的法會器具，避免只視為精巧小雕像。</p><p class="object-source"><a href="https://www.todaiji.or.jp/information/museum/" target="_blank" rel="noopener">官方館藏圖入口 ↗</a></p></article>
      <article data-object-material="bronze"><span>金銅佛 · 8世紀</span><h3>菩薩半跏像</h3><p><strong>先理解：</strong>半跏姿把一腿垂下、另一腿屈放，常用於沉思或即將起身救濟的菩薩形象。小型金銅佛便於供養、移動與近距離禮拜。</p><p><strong>現場看：</strong>寶冠、面相、指尖、膝部轉折與衣紋在極小尺度如何保持清楚；再看鑄造後修整、鍍金殘留與磨蝕。</p><p class="object-source"><a href="https://www.todaiji.or.jp/information/museum/" target="_blank" rel="noopener">官方館藏圖入口 ↗</a></p></article>
      <article data-object-material="bronze"><span>鍍金銅 · 8世紀</span><h3>釋迦／多寶如來坐像</h3><p><strong>先理解：</strong>兩佛並坐源自《法華經》見寶塔品：多寶如來證明釋迦說法真實，釋迦入塔並坐。成對配置本身就是經文敘事。</p><p><strong>現場看：</strong>兩像手印、身軀比例、衣紋與背光是否刻意相近；共享空間如何讓「兩尊」讀成「一個事件」。</p><p class="object-source"><a href="https://www.todaiji.or.jp/information/museum/" target="_blank" rel="noopener">官方館藏圖入口 ↗</a></p></article>
